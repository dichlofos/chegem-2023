...
- [github](https://github.com): средство хранения материалов отчёта
- [nakarte](https://nakarte.me): инструмент визуализации GPX-треков
- [gpx_tools](https://github.com/dichlofos/gpx_tools): инструменты для обработки GPX-треков
- Финансовый коммунизм: инструмент для расчёта финансов после похода
