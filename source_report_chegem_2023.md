...
TODO
Итого активными способами передвижения (по&nbsp;GPS): ????&nbsp;км / ????&nbsp;км (c учетом коэффициента&nbsp;1.2), набор высоты 7965&nbsp;м, сброс высоты 7835&nbsp;м.
...
Здесь устраиваем переправу с использованием верёвки. Воды много, а это для многих участников группы вообще первый брод в жизни. Оценив глубину палкой,
приходим к выводу, что опытный человек такое достаточно уверенно пройдёт. А вот новичку может быть страшновато.

Переход выполняем в касках, используя треккинговые палки.

Руководитель переходит реку с рюкзаком (так устойчивее), упираясь в дно треккинговыми палками, выдвинутыми почти на всю длину. Брызги летят до пояса, но основная масса воды
...
делает крутой поворот (`N 43.36924 E 42.93736` GPS). Место не самое удобное, но здесь за водой ходить недалеко,
...
За 2 ходки выходим на седловину (`N 43.32155 E 42.99424` GPS). Седловина пригодна для установки ненулевого количества палаток, воды непосредственно
...
Там устраиваем обед (`N 43.30876 E 43.01884` GPS) и выясняем подробности травмы участницы. Причиной послужила не самая удачная
...
Вставить Джилги, Джилги Вост и Кестантытау куда надо: TODO
